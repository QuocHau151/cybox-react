          ...
          <div className="row">
            <div className="col-xl-5 col-lg-5 col-md-5">
              <div className="image-details" data-aos="fade-right" data-aos-duration="800">
                <img src={require("../assets/images/common/team6.png")} alt="" />
              </div>
            </div>
            <div className="col-xl-7 col-lg-7 col-md-7">
              <div className="info-detail" data-aos="fade-left" data-aos-duration="800">
                ...
                <div className="box">
                  ...
                  <p>
                    Purus, laoreet dui augue ut euismod. Elementum ante sociis volutpat tellus enim,
                ...
                <div className="box contact">
                  ...
                  <p>Cecilia Chapman 711-2880 Nulla St.Mankato United States (257) 563-7401</p>
                  ...
                  <li>
                    <Link to="#">
                      <svg
                        ...
                        <path
                          d="M17.6441 3.17999C18.5012 2.64381 19.1425 1.79954 19.4483 0.804803C18.6429 1.30486 17.7618 1.65711 16.8429 1.84632C15.569 0.436146 13.5505 0.0929726 11.9155 1.00856C10.2804 1.92415 9.4335 3.87183 9.84798 5.76329C6.54901 5.58997 3.47544 3.9593 1.3921 1.27704C0.304847 3.23944 0.860458 5.74806 2.66182 7.00991C2.01043 6.988 1.37348 6.80345 0.804092 6.47164C0.804092 6.48965 0.804092 6.50766 0.804092 6.52567C0.804469 8.56985 2.18125 10.3307 4.09599 10.7358C3.49179 10.9078 2.85802 10.9331 2.24304 10.8098C2.78153 12.558 4.32121 13.7556 6.07611 13.7913C4.62265 14.985 2.82769 15.6324 0.980017 15.6292C0.65252 15.6297 0.32528 15.61 0 15.5702C1.87627 16.8319 4.06002 17.5015 6.29028 17.4992C9.39311 17.5215 12.375 16.2414 14.569 13.9454C16.763 11.6494 17.986 8.52892 17.9644 5.28205C17.9644 5.09595 17.9603 4.91086 17.952 4.72677C18.7556 4.11907 19.4491 3.36624 20 2.50365C19.2514 2.85089 18.4573 3.07887 17.6441 3.17999Z"
                          fill="white"
                        />
                      </svg>
                    </Link>
